...
export const SEED_LEADS: Lead[] = [
  { id: 'l1', salon: 'Luxe Hair Studio', city: 'Portland, ME', phone: '(207) 555-0142', website: 'luxehairstudio.com', bookingSystem: 'Vagaro', stage: 'working', cadenceId: 'c1', cadencePos: 1, objection: 'Timing', lastTouch: 'Texted · 1d', contact: { id: 'ct1', name: 'Dana Ortiz', role: 'Owner', phone: '(207) 555-0142' } },
  ...
  { id: 'l3', salon: 'Shear Bliss Salon', city: 'Provo, UT', phone: '(801) 555-0110', website: 'shearblissprovo.com', bookingSystem: 'Square Appointments', stage: 'hot', cadenceId: 'c1', cadencePos: 3, objection: 'Price / contract', lastTouch: 'Called · 4h', contact: { id: 'ct3', name: 'Marisol Vega', role: 'Owner', phone: '(801) 555-0110' } },
  ...
  { id: 'l6', salon: 'Golden Shears Co.', city: 'Meridian, ID', phone: '(208) 555-0165', website: 'goldenshearsco.com', bookingSystem: 'Boulevard', stage: 'hot', cadenceId: 'c1', cadencePos: 4, objection: 'Price / contract', lastTouch: 'Demo done · 1d', contact: { id: 'ct6', name: 'Tom Alvarez', role: 'Owner', phone: '(208) 555-0165' } },
