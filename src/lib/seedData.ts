...
export const SEED_LEADS: Lead[] = [
  ...
  { id: 'l5', salon: 'Halo Blow Dry Bar', city: 'Mesa, AZ', phone: '(480) 555-0177', stage: 'working', cadenceId: 'c1', cadencePos: 1, objection: 'Timing', lastTouch: 'Emailed · 2d', contact: { id: 'ct5', name: 'Priya N.', role: 'Owner', phone: '(480) 555-0177' } },
